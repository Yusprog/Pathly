...
|  [KD Tree](https://github.com/Yusprog/Pathly/tree/78ccc1e8dcb64363d50558d722b19d03ff129d2a/bearmaps/proj2ab)    | A K-Dimensional Tree backs the A* search algorithm, allowing efficient nearest neighbor lookup averaging O(log(n)) time.                                    |
